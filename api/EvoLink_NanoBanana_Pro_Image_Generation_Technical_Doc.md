...
## Nanobanana Pro (gemini-3-pro-image-preview) Image Generation & Query Task Status

---

> **Source:** https://docs.evolink.ai/en/api-manual/image-series/nanobanana/nanobanana-pro-image-generate

---

# Nanobanana Pro Image Generation

> - Nano Banana Pro (gemini-3-pro-image-preview) model supports text-to-image, image-to-image, image editing and other generation modes
...
openapi: 3.1.0
info:
  title: Nano Banana Pro Interface
  description: >-
...
paths:
  /v1/images/generations:
    post:
      tags:
        - Image Generation
      summary: Nano Banana Pro Interface
      description: >-
        - Nano Banana Pro (gemini-3-pro-image-preview) model supports
...
# Query Task Status (Get Task Detail)

> **Source:** https://docs.evolink.ai/en/api-manual/task-management/get-task-detail
