...
- [x] **#313-3 FCP XML xmeml v5 스펙 위반 수정** — (1) generateFcpXml: file 정의가 clipitem 내부 → 트랙 최상단 이동 (2) generateFcpXmlFromEdl: fileDefsXml.slice()→전체 출력 (다중 소스 지원) (nleExportService.ts, 2026-03-15)
