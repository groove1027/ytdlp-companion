...
- [x] **영상 분석실 SRT 레이어 분리 + 대본 복사 3종 + 숏폼 줄바꿈** — (1) SRT 다운로드 시 효과자막/일반자막/통합 3개 파일 레이어 분리 ZIP (2) 대본 복사 버튼 → 3종 드롭다운(TTS만 복사: 구두점/기호/화자 제거, 오리지널 대사 복사, 모두 복사) (3) 숏폼 영상(90초 이하) SRT 자동 ~12자 줄바꿈 (4) stripForTts/breakSubtitleLines 유틸 추가 (VideoAnalysisRoom.tsx, 2026-03-14)
