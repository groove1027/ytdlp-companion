...
- [x] **이미지/영상 비주얼 스타일에 컨트리볼 카테고리 추가** — VISUAL_STYLES에 "🌍 컨트리볼 (Countryball)" 신규 카테고리 추가 (8개국: 독일/미국/노르웨이/한국/폴란드/영국/일본/러시아). 국가별 고유 표정+액세서리 프리셋. 미리보기 이미지 8장 생성 (constants.ts, visual-previews/7/, generate-visual-previews.mjs, 2026-03-16)
