...
export interface Scene {
  ...
  referenceSearchBaseQuery?: string; // 무료 레퍼런스 재검색용 장면 기반 기준 검색어
...
export type VideoAnalysisPreset = 'tikitaka' | 'snack' | 'condensed' | 'deep' | 'shopping' | 'alltts' | 'dubbing' | 's2s' | 'l2s';
