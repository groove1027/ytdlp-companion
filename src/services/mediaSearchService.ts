...
const KO_EN_MAP: Record<string, string> = {
  ...
  // ── 장면 묘사용 키워드 (대본 기반 밈/일러스트 매칭 강화) ──
  '할머니': 'grandmother grandma old woman elderly',
  '할아버지': 'grandfather grandpa old man elderly',
  '아이': 'child kid children boy girl',
  '아이들': 'children kids playing',
  '아저씨': 'man uncle middle-aged',
  '아줌마': 'woman aunt middle-aged',
  '농부': 'farmer farming agriculture field',
  '가족': 'family together gathering',
  '엄마': 'mother mom woman',
  '아빠': 'father dad man',
  '부부': 'couple husband wife married',
  '친구': 'friend friends buddy',
  '선생님': 'teacher school education',
  '학생': 'student school study',
  '의사': 'doctor hospital medical',
  '경찰': 'police officer cop',
  '군인': 'soldier military army',
  '요리사': 'chef cook cooking kitchen',
  '마을': 'village town rural',
  '시골': 'countryside rural village farm',
  '도시': 'city urban building skyline',
  '골목': 'alley street narrow path',
  '가게': 'shop store market',
  '시장': 'market shopping vendor',
  '마당': 'yard garden courtyard',
  '논밭': 'rice field farm paddy',
  '들판': 'field meadow plain',
  '안개': 'fog mist morning',
  '아침': 'morning sunrise dawn',
  '저녁': 'evening sunset dusk',
  '노을': 'sunset golden hour sky',
  '밤': 'night dark evening',
  '빨래': 'laundry washing clothes',
  '신문': 'newspaper reading news',
  '놀다': 'play playing fun',
  '뛰다': 'run running jump',
  '걷다': 'walk walking',
  '앉다': 'sit sitting',
  '먹다': 'eat eating food meal',
  '자다': 'sleep sleeping rest',
  '울다': 'cry crying tears sad',
  '웃다': 'laugh laughing smile happy',
  '이야기': 'talk talking conversation chat story',
  '대화': 'conversation talk chat dialogue',
  '사무실': 'office work desk business',
  '회사': 'company office business work',
  '병원': 'hospital medical doctor nurse',
  '식당': 'restaurant eating food dining',
  '카페': 'cafe coffee shop',
  '공원': 'park nature tree bench',
  '해변': 'beach sea ocean summer',
  '하늘': 'sky cloud blue',
  '구름': 'cloud sky weather',
  '햇살': 'sunlight sunshine bright warm',
  '전쟁': 'war battle fight military',
  '사고': 'accident crash incident',
  '범죄': 'crime criminal police',
  '재판': 'trial court judge law',
  '뉴스': 'news report broadcast media',
  '방송': 'broadcast tv show media',
  '인터뷰': 'interview question answer',
  '발표': 'presentation announcement speech',
  '회의': 'meeting conference discussion',
  '여행': 'travel trip journey tourism',
  '등산': 'hiking mountain climbing',
  '수영': 'swimming pool water',
  '자전거': 'bicycle bike cycling',
  '기차': 'train railway station',
  '버스': 'bus transportation',
  '배': 'ship boat sailing',
  '지도': 'map navigation direction',
  '선물': 'gift present surprise',
  '편지': 'letter mail writing',
  '우산': 'umbrella rain weather',
  '모자': 'hat cap headwear',
  '안경': 'glasses eyewear',
  '가방': 'bag backpack luggage',
  '열쇠': 'key lock door',
  '시계': 'clock watch time',
  '거울': 'mirror reflection',
  '계단': 'stairs steps staircase',
  '창문': 'window glass view',
  '지붕': 'roof house building',
  '다리': 'bridge crossing river',
  '강': 'river stream water nature',
  '호수': 'lake pond water nature',
  '숲': 'forest woods trees nature',
  '동굴': 'cave cavern dark',
  '사막': 'desert sand dry',
  '폭포': 'waterfall cascade nature',
  '무지개': 'rainbow colorful sky',
  '고기': 'meat food steak',
  '과일': 'fruit apple banana orange',
  '채소': 'vegetable salad healthy',
  '빵': 'bread bakery toast',
  '케이크': 'cake dessert birthday sweet',
  '아이스크림': 'ice cream dessert sweet',
  '라면': 'ramen noodle soup',
  '밥': 'rice meal food bowl',
  '김치': 'kimchi korean food',
  '돼지': 'pig pork animal farm',
  '소고기': 'beef cow cattle',
  '말타기': 'horse riding',
  '닭': 'chicken hen poultry',
  '토끼': 'rabbit bunny cute',
  '곰': 'bear animal forest',
  '사자': 'lion king animal safari',
  '코끼리': 'elephant big animal',
  '원숭이': 'monkey ape primate',
  '물고기': 'fish sea ocean aquarium',
  '나비': 'butterfly insect beautiful',
  '벌': 'bee honey insect',
  '개미': 'ant insect small',
  '거미': 'spider web insect',
  '뱀': 'snake reptile danger',
  '공룡': 'dinosaur prehistoric ancient',
};
