  ...
  */
  ...
  return (
    <>
      ...
      <WatermarkRemoverModal isOpen={isWatermarkModalOpen} onClose={() => setIsWatermarkModalOpen(false)} />
      */}
      ...
      <div className={`fixed top-0 right-0 h-full w-80 bg-gray-900 border-l border-gray-700 shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        <div className="p-6 h-full flex flex-col">
          ...
          <button
            ...
            className="w-full bg-gray-800 hover:bg-gray-700 border border-cyan-800/50 text-gray-300 font-bold py-2 px-4 rounded-lg mb-6 flex items-center justify-center gap-2 transition-all text-sm hover:border-cyan-600/50"
          >
